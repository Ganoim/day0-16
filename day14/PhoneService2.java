...
public class PhoneService2 {
	...
	public void registInfo() {
		...
		System.out.println("현재 등록된 연락처 수 : " + phoneBookList.size()); // 현재 저장되어 있는 수확인
	...
	public void modifyInfo() {
		...
		if(idx > -1) {
		 ...
		 /* System.out.print("수정할 이름 입력>>");
			pbList[idx].setName(scan.next());
			System.out.print("수정할 전화번호 입력>>");
			pbList[idx].setPhoneNum(scan.next());
			System.out.println("이름과 전화번호가 수정되었습니다."); */
			...
			case 1:
				...
				break;
			case 2:
				String oldPhone = phoneBookList.get(idx).getPhoneNum();
				System.out.print("수정할 전화번호 입력>>");
				String newPhone = scan.next();
				phoneBookList.get(idx).setPhoneNum(newPhone);
				System.out.println("["+oldPhone+"] >>" +"["+newPhone+"]\n으로 수정되었습니다");
				break;
			default:
	...
	*/
	public void deleteInfo() {
		...
		if(idx > -1) {
			...
			phoneBookList.get(idx).setPhoneNum(searchName);
